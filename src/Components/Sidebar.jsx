...
import {setClear, setLeftBar} from "../state/index";
...
export const Sidebar = () => {
  ...
  return (
    <div className='w-[15%] h-screen bg-slate-800 p-2 flex flex-col justify-center items-center sm:w-[6%]'>
        ...
        <div className='flex mt-16 w-full h-full gap-8 flex-col items-center'>
            ...
            <BsChatLeft cursor={"pointer"} onClick={() => dispatch(setLeftBar(!leftBar))} className={`${selected == "chat" ? "text-green-500" : "text-gray-300"}`} fontSize={"1.35rem"} />
